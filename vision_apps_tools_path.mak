...
ifeq ($(SOC),j721e)
  export PSDK_LINUX_PATH ?= /home/$(USER)/ti-processor-sdk-linux-j7-evm-08_02_00_03
else ifeq ($(SOC),j721s2)
  export PSDK_LINUX_PATH ?= /home/$(USER)/ti-processor-sdk-linux-j721s2-evm-08_00_04_03
endif
